<div class="contentNavArea">
	...
	<table cellpadding="0" cellspacing="0" border="0" height="30" id="contentNavTable">
		...
		<tr>
			...
			<? if (checkPerms('can_view_assets')) { ?>
			
				<td id="contentTab3" class="tabNavOff"><a href="#" id="contentTabLink3" class="tabNavOff" onclick="return false;" onmousedown="opm.changeContent(3,'assets','properties'); this.blur(); return false;">Assets</a></td>
