...
{
	global $productline;
	global $grabsheetinfo;
	
	//print_r($grabsheetinfo);
	//die();
	...
	if (defined('GRABSHEET_IMAGEPATH')) {
	
		$imageWidth = GRABSHEET_IMAGEWIDTH;
		$brandingLogoOffset = 767 - $imageWidth;
	
		$this->Image(GRABSHEET_IMAGEPATH,$brandingLogoOffset,15,$imageWidth); //78
		//Arial bold 15
	...
	if (defined('GRABSHEET_PROPERTYIMAGEPATH') && GRABSHEET_PROPERTYIMAGEPATH) {
	
		$this->Image(GRABSHEET_PROPERTYIMAGEPATH,20,15,200);
		//$headertext = strtoupper(GRABSHEET_TITLE);
		//$this->Text(20,55,$headertext);
...
//Page footer
	function Footer()
	{
		...
		$this->Text(580,587,'Created ' . date('l dS \of F Y h:i:s A'));
	}
}
