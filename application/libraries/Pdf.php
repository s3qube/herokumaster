...
class pdf extends TCPDF {
	...
	public function Header() {
        ...
        $img_file = K_PATH_IMAGES.'Bravado_OPM_Invoice_Template2.png';
        $this->Image($img_file, 1, -1.5, 214, 279, '', '', '', false, 300, '', false, false, 0);
        ...
        // other various invoice info
        $this->SetFillColor(255,255,255);
      //  $this->SetXY(155, 8);
      //  $this->Cell(50, 8, '<b>Invoice #</b> ' . INVOICEID . "\n Reference#", 1, 1, 'C', true);
		
		$this->WriteHTMLCell(50, 8, 155,8, '<b>Invoice #</b> ' . INVOICEID . "<br><b>Reference #</b> " . REFNUM,1,1,true);
		
		if (defined('INVOICEIMAGE_PATH')) {
			
			$this->Image(INVOICEIMAGE_PATH, 10, 5, 75, 0, '', '', '', false, 300);

			//$this->WriteHTMLCell(100, 8, 10, 8, "<img src=\"". INVOICEIMAGE_PATH ."\" />",1,1,true);
		}
		...
		/*$html = "<table border='1'>
					<tr>
						<td><div style='border:solid 1px #000000;'>INVOICE # 4416</div></td>
					</tr>
				</table>";
